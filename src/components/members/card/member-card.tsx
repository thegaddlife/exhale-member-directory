    ...
    <>
      <div className="space-y-4">
        <div className="aspect-w-3 aspect-h-2">
          <img className="object-cover rounded-lg shadow-lg" src="/default-img.jpg" alt="" />
        </div>
        ...
        <div className="text-lg">
          <p className="text-gray-500">{member.blurb}</p>
        </div>
        ...
        <ul className="flex space-x-5">
          ...
          <li>
            <a href={member.insta} className="text-gray-400 hover:text-gray-500">
